...
df = pd.read_csv (r"burs_nachbac_baseline.csv")   
#var= open(r'C:/Users/prakr/OneDrive/Desktop/Term paper/burs_nachbac_baseline.csv','r')

df = df.iloc[0:1440,0:32]
#df = df[0:1440]
print(df)
ls = []                                             
...
for i in sleep_per_day:
    ...
    countm.append
#print(countm)
sleep_per_fly=[countm[24*x:24*x+24] for x in range(0,math.ceil(len(countm)/24))]
#print(sleep_per_fly)
...
writer2 = pd.ExcelWriter('pop.xlsx')
